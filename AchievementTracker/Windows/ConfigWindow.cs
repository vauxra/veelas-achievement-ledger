...
public sealed class ConfigWindow : Window
{
    ...
    private void DrawHelp()
    {
        ...
        ImGui.TextWrapped("Achieve Ex+ uses a user-guided native Achievement UI flow. Reload buttons open the game's Achievement entry; the plugin passively caches progress the client returns.");
        ImGui.Separator();
