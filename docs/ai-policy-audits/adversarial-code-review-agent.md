...
Use this prompt for a fresh-context reviewer before committing or shipping changes to the Achieve Ex+ plugin. The reviewer should be intentionally skeptical and should fail closed.
...
## Expected stance for Achieve Ex+ V1
