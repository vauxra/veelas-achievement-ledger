...
Source: https://dalamud.dev/plugin-publishing/submission

Fetched: 2026-06-09T02:42:42.570435+00:00

SHA256: `3c5951399f0f20ff3be812370fe57b4bb319dab5da908777a97361c84a73d17a`

---

The Submission Process | Dalamud 
...
is a relatively involved process where a plugin developer will build yet
another manifest file and submit it to our GitHub Repository for
inclusion in the official ("mainline") plugin repository.

info
Before submitting your plugin, make sure you have:

Set up your plugin metadata 
correctly
...
Ensured your plugin meets all restrictions 

Read the AI Usage Policy and, if applicable, disclosed your
level of AI use in your pull request description

The D17 Workflow ​ 

Dalamud's plugin workflow is managed by a system called Plogon , which
...
you must open a pull request against the DalamudPluginsD17 repository.
This pull request must be formatted in a specific way, and follow certain system
requirements.

Please ensure you're only modifying one plugin per submission and pull
...
Note that new plugins must be submitted to the testing track; that is, their
...
The D17 Workflow 
Submitting a Plugin Submitting Plugin Updates 
Changing Release Tracks
